...
import { ArrowLeft, Mail, Send, Sparkle, Sparkles, Vote } from "lucide-react";
        ...
        <div className="space-y-6 flex flex-col">
            <div className="flex space-x-4">
                ...
                <div className="flex flex-col space-y-4">
                    <h1 className="text-4xl font-bold">John Williams</h1>
            ...
            <Card className="h-full flex-grow rounded-3xl relative">
                ...
                <CardContent className="space-y-4 pb-4">
                    <h3 className="font-bold text-3xl line-clamp-2">
                        Letter to representative John Williams
                    </h3>
